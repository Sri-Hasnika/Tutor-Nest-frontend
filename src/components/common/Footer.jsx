      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/schedule/book" className="text-gray-600 hover:text-primary">
                  Book a Session
                </Link>
              </li>
              <li>
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900">For Tutors</h3>
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/tutor-application" className="text-gray-600 hover:text-primary">
                  Become a Tutor
                </Link>
              </li>
              <li>
                <Link to="/tutor-resources" className="text-gray-600 hover:text-primary">
                  Teaching Resources
                </Link>
              </li>
              <li>
                <Link to="/tutor-community" className="text-gray-600 hover:text-primary">
                  Tutor Community
                </Link>
              </li>
              <li>
                <Link to="/tutor-faq" className="text-gray-600 hover:text-primary">
                  Tutor FAQ
                </Link>
              </li>
              <li>
                <Link to="/tutor-success" className="text-gray-600 hover:text-primary">
                  Success Stories
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">&copy; {currentYear} EduConnect. All rights reserved.</p>
